...
#> data.table 1.17.8 using 24 threads (see ?getDTthreads).  Latest news: r-datatable.com
...
<p class="caption">plot of chunk model-performance-plot</p>
</div>
...
#> Warning in .complete_new_prediction_table(object): The positive class cannot be directly inferred from names of the provided prediction data, and is assumed to be yes.
...
#> Error in familiar::plot_model_performance(data = predictions, metric = c("auc", : argument "object" is missing, with no default

plots[[1L]]
```

<div class="figure" style="text-align: center">
<img src="eval_and_explain/model-performance-plot-standalone-1.png" alt="plot of chunk model-performance-plot-standalone"  />
<p class="caption">plot of chunk model-performance-plot-standalone</p>
</div>
...
results
#> [[1]]
#> An object of class "familiarDataElementModelPerformance"
#> Slot "data":
#>                      data_set vimp_method                      learner ensemble_model_name   metric     value    ci_low     ci_up
#>                        <fctr>      <fctr>                       <fctr>              <fctr>   <fctr>     <num>     <num>     <num>
#> 1: 94528_vaYlrMM6XXSNOt9rEIz4        none random_forest_ranger_default      ensemble.NA.NA      auc 0.7117647 0.4998611 0.9001974
#> 2: 94528_vaYlrMM6XXSNOt9rEIz4        none random_forest_ranger_default      ensemble.NA.NA    brier 0.2139492 0.1685492 0.2583556
#> 3: 94528_vaYlrMM6XXSNOt9rEIz4        none random_forest_ranger_default      ensemble.NA.NA f1_score 0.6666667 0.4347826 0.8387097
#> 
#> Slot "identifiers":
#> named list()
#> 
...
#> [1] "hybrid"
#> 
#> Slot "estimation_type":
#> [1] "bootstrap_confidence_interval"
#> 
#> Slot "confidence_level":
#> [1] 0.95
#> 
#> Slot "bootstrap_ci_method":
#> [1] "percentile"
#> 
#> Slot "value_column":
#> [1] "value"  "ci_low" "ci_up" 
#> 
#> Slot "grouping_column":
#> [1] "ensemble_model_name" "metric"              "data_set"            "vimp_method"         "learner"            
#> 
#> Slot "is_aggregated":
#> [1] TRUE
```
...
<p class="caption">plot of chunk auc-roc-curve-bci</p>
</div>
...
<p class="caption">plot of chunk auc-roc-curve-point</p>
</div>
...
<p class="caption">plot of chunk auc-pr-curve-bci</p>
</div>
...
<p class="caption">plot of chunk auc-pr-curve-point</p>
</div>
...
<p class="caption">plot of chunk confusion-matrix</p>
</div>
...
<p class="caption">plot of chunk kaplan-meier-plot</p>
</div>
...
<p class="caption">plot of chunk calibration-data-bci</p>
</div>
...
<p class="caption">plot of chunk calibration-data-point</p>
</div>
...
<p class="caption">plot of chunk decision-curve-bci</p>
</div>
...
<p class="caption">plot of chunk model-variable-importance</p>
</div>
...
<p class="caption">plot of chunk permutation-variable-importance-bc</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/shap_summary-1.png" alt="plot of chunk shap_summary"  />
<p class="caption">plot of chunk shap_summary</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/shap_summary_violin-1.png" alt="plot of chunk shap_summary_violin"  />
<p class="caption">plot of chunk shap_summary_violin</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/shap_summary_bar-1.png" alt="plot of chunk shap_summary_bar"  />
<p class="caption">plot of chunk shap_summary_bar</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/ice-max-remodeling-ratio-1.png" alt="plot of chunk ice-max-remodeling-ratio"  />
<p class="caption">plot of chunk ice-max-remodeling-ratio</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/ice-max-remodeling-ratio-anchored-1.png" alt="plot of chunk ice-max-remodeling-ratio-anchored"  />
<p class="caption">plot of chunk ice-max-remodeling-ratio-anchored</p>
</div>
...
<p class="caption">plot of chunk ice-2d</p>
</div>
...
<p class="caption">plot of chunk ice-2d-anchored</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/shap-dependence-1.png" alt="plot of chunk shap-dependence"  />
<p class="caption">plot of chunk shap-dependence</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/shap-dependence-interaction-1.png" alt="plot of chunk shap-dependence-interaction"  />
<p class="caption">plot of chunk shap-dependence-interaction</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/shap-dependence_interaction_2-1.png" alt="plot of chunk shap-dependence_interaction_2"  />
<p class="caption">plot of chunk shap-dependence_interaction_2</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/shap_force_plot-1.png" alt="plot of chunk shap_force_plot"  />
<p class="caption">plot of chunk shap_force_plot</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/shap_force_plot_highlight-1.png" alt="plot of chunk shap_force_plot_highlight"  />
<p class="caption">plot of chunk shap_force_plot_highlight</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="eval_and_explain/shap_waterfall-1.png" alt="plot of chunk shap_waterfall"  />
<p class="caption">plot of chunk shap_waterfall</p>
</div>
...
<p class="caption">plot of chunk feature-similarity</p>
</div>
...
<p class="caption">plot of chunk sample-similarity</p>
</div>
...
<p class="caption">plot of chunk sample-similarity-unnormalised</p>
</div>

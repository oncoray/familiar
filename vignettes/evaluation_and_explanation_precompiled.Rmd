...
#> Warning in familiar::as_prediction_table(x = predictions$yes, y = ischemic_stroke_data$stroke, : The positive class cannot be directly inferred from names of the provided prediction data, and is assumed to be yes.
...
```
<div class="figure" style="text-align: center">
<img src="eval_and_explain/model-performance-plot-standalone-1.png" alt="Model performance obtained using a prediction table."  />
<p class="caption">Model performance obtained using a prediction table.</p>
</div>

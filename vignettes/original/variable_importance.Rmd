...
shuffled prior to building a model to avoid influence of the provided feature
order.
...
In case of variable importance or modelling in the presence of resampling (e.g.
